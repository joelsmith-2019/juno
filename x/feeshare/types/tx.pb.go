...
// Start counter messages
type MsgStartCounter struct {
	// deployer_address is the bech32 address of message sender. It must be the
	// same the contract's admin address
...
func (m *MsgStartCounter) Reset()         { *m = MsgStartCounter{} }
func (m *MsgStartCounter) String() string { return proto.CompactTextString(m) }
func (*MsgStartCounter) ProtoMessage()    {}
func (*MsgStartCounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_db5ab2575863a062, []int{8}
}
func (m *MsgStartCounter) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgStartCounter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgStartCounter.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgStartCounter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgStartCounter.Merge(m, src)
}
func (m *MsgStartCounter) XXX_Size() int {
	return m.Size()
}
func (m *MsgStartCounter) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgStartCounter.DiscardUnknown(m)
}

var xxx_messageInfo_MsgStartCounter proto.InternalMessageInfo

func (m *MsgStartCounter) GetDeployerAddress() string {
	if m != nil {
		return m.DeployerAddress
	}
	return ""
...
// Start counter response messages
type MsgStartCounterResponse struct {
}

func (m *MsgStartCounterResponse) Reset()         { *m = MsgStartCounterResponse{} }
func (m *MsgStartCounterResponse) String() string { return proto.CompactTextString(m) }
func (*MsgStartCounterResponse) ProtoMessage()    {}
func (*MsgStartCounterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_db5ab2575863a062, []int{9}
}
func (m *MsgStartCounterResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgStartCounterResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgStartCounterResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgStartCounterResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgStartCounterResponse.Merge(m, src)
}
func (m *MsgStartCounterResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgStartCounterResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgStartCounterResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgStartCounterResponse proto.InternalMessageInfo

// Stop counter messages
type MsgStopCounter struct {
	// deployer_address is the bech32 address of message sender. It must be the
	// same the contract's admin address
	DeployerAddress string `protobuf:"bytes,1,opt,name=deployer_address,json=deployerAddress,proto3" json:"deployer_address,omitempty"`
}

func (m *MsgStopCounter) Reset()         { *m = MsgStopCounter{} }
func (m *MsgStopCounter) String() string { return proto.CompactTextString(m) }
func (*MsgStopCounter) ProtoMessage()    {}
func (*MsgStopCounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_db5ab2575863a062, []int{10}
}
func (m *MsgStopCounter) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgStopCounter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgStopCounter.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgStopCounter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgStopCounter.Merge(m, src)
}
func (m *MsgStopCounter) XXX_Size() int {
	return m.Size()
}
func (m *MsgStopCounter) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgStopCounter.DiscardUnknown(m)
}

var xxx_messageInfo_MsgStopCounter proto.InternalMessageInfo

func (m *MsgStopCounter) GetDeployerAddress() string {
	if m != nil {
		return m.DeployerAddress
	}
	return ""
...
type MsgStopCounterResponse struct {
}

func (m *MsgStopCounterResponse) Reset()         { *m = MsgStopCounterResponse{} }
func (m *MsgStopCounterResponse) String() string { return proto.CompactTextString(m) }
func (*MsgStopCounterResponse) ProtoMessage()    {}
func (*MsgStopCounterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_db5ab2575863a062, []int{11}
}
func (m *MsgStopCounterResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgStopCounterResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgStopCounterResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgStopCounterResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgStopCounterResponse.Merge(m, src)
}
func (m *MsgStopCounterResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgStopCounterResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgStopCounterResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgStopCounterResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgStartCounter)(nil), "juno.feeshare.v1.MsgStartCounter")
	proto.RegisterType((*MsgStartCounterResponse)(nil), "juno.feeshare.v1.MsgStartCounterResponse")
	proto.RegisterType((*MsgStopCounter)(nil), "juno.feeshare.v1.MsgStopCounter")
	proto.RegisterType((*MsgStopCounterResponse)(nil), "juno.feeshare.v1.MsgStopCounterResponse")
}
...
var fileDescriptor_db5ab2575863a062 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// StartCounter stars it.
	StartCounting(ctx context.Context, in *MsgStartCounter, opts ...grpc.CallOption) (*MsgStartCounterResponse, error)
	// StopCounter stops the counter.
	StopCounting(ctx context.Context, in *MsgStopCounter, opts ...grpc.CallOption) (*MsgStopCounterResponse, error)
...
func (c *msgClient) StartCounting(ctx context.Context, in *MsgStartCounter, opts ...grpc.CallOption) (*MsgStartCounterResponse, error) {
	out := new(MsgStartCounterResponse)
	err := c.cc.Invoke(ctx, "/juno.feeshare.v1.Msg/StartCounting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) StopCounting(ctx context.Context, in *MsgStopCounter, opts ...grpc.CallOption) (*MsgStopCounterResponse, error) {
	out := new(MsgStopCounterResponse)
	err := c.cc.Invoke(ctx, "/juno.feeshare.v1.Msg/StopCounting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// StartCounter stars it.
	StartCounting(context.Context, *MsgStartCounter) (*MsgStartCounterResponse, error)
	// StopCounter stops the counter.
	StopCounting(context.Context, *MsgStopCounter) (*MsgStopCounterResponse, error)
	// Update the params of the module through gov v1 type.
...
func (*UnimplementedMsgServer) StartCounting(ctx context.Context, req *MsgStartCounter) (*MsgStartCounterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartCounting not implemented")
}
func (*UnimplementedMsgServer) StopCounting(ctx context.Context, req *MsgStopCounter) (*MsgStopCounterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StopCounting not implemented")
}
...
func _Msg_StartCounting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgStartCounter)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).StartCounting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/juno.feeshare.v1.Msg/StartCounting",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).StartCounting(ctx, req.(*MsgStartCounter))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_StopCounting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgStopCounter)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).StopCounting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/juno.feeshare.v1.Msg/StopCounting",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).StopCounting(ctx, req.(*MsgStopCounter))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StartCounting",
			Handler:    _Msg_StartCounting_Handler,
		},
		{
			MethodName: "StopCounting",
			Handler:    _Msg_StopCounting_Handler,
		},
		{
...
func (m *MsgStartCounter) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgStartCounter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgStartCounter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgStartCounterResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgStartCounterResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgStartCounterResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgStopCounter) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgStopCounter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgStopCounter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgStopCounterResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgStopCounterResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgStopCounterResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgStartCounter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgStartCounterResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgStopCounter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgStopCounterResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgStartCounter) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgStartCounter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgStartCounter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgStartCounterResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgStartCounterResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgStartCounterResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *MsgStopCounter) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgStopCounter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgStopCounter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgStopCounterResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgStopCounterResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgStopCounterResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
